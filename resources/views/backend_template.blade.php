  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">Online <sup>Shop</sup></div>
      </a>
      ...
      <li class="nav-item {{request()->routeIs('categories*') || request()->routeIs('subcategories*') ? 'active' : '' }}">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          <i class="fas fa-fw fa-cog"></i>
          <span>Categories</span>
        </a>
        <div id="collapseUtilities" class="collapse {{request()->routeIs('categories*') || request()->routeIs('subcategories*') ? 'show' : '' }}" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{request()->routeIs('categories*') ? 'active' : '' }}" href="{{ route('categories.index') }}">Category List</a>
            <a class="collapse-item {{request()->routeIs('subcategories*') ? 'active' : '' }}" href="{{ route('subcategories.index') }}">Sub-category List</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Online Shop 2020 | Laraval Project</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
