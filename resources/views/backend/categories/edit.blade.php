      ...
      <div class="card-body">
      	...
      	<form method="post" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data">
      		...
      		<div class="form-group row mb-lg-4">
				    <label for="name" class="col-md-3 col-form-label">Category Name: <sup class="text-danger">*</sup></label>
				    <div class="col-md-9">
				  ...
				  <div class="form-group row mb-lg-4">
				    <label for="image" class="col-md-3 col-form-label">Category Photo: <sup class="text-danger">*</sup></label>
				    <div class="col-md-9">
				    	<input type="hidden" name="old_photo" value="{{ $category->photo }}">
				    	
				    	<div class="row" id="div-old-photo">
				    		<div class="col-5 col-lg-2">
					     		<img src="{{ asset($category->photo) }}" class="shadow d-block mb-3 img-fluid">
				    		</div>
...
@section('script')
    ...
    $(function () {
    	...
    	$('#btn-undo').click(function() {
    		...
    		$('#image').val('');
    		$('.custom-file-label').html('Choose Category Photo');
