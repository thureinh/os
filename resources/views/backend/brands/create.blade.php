...
@section('content')
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info">Add New Brand</h6>
      </div>
      <div class="card-body">
      	...
      	<form method="post" action="{{ route('brands.store') }}" enctype="multipart/form-data">
      		...
      		<div class="form-group row mb-lg-4">
				    <label for="name" class="col-lg-3 col-form-label">Brand Name: <sup class="text-danger">*</sup></label>
				    <div class="col-lg-9">
				  ...
				  <div class="form-group row mb-lg-4">
				    <label for="image" class="col-lg-3 col-form-label">Brand Photo: <sup class="text-danger">*</sup></label>
				    <div class="col-lg-9">
