      ...
      <div class="card-body">
      	...
      	<form method="post" action="{{ route('subcategories.store') }}" enctype="multipart/form-data">
      		...
      		<div class="form-group row mb-lg-4">
				    <label for="name" class="col-lg-3 col-form-label">Subcategory Name: <sup class="text-danger">*</sup></label>
				    <div class="col-lg-9">
				      <input type="text" class="form-control" id="name" name="name" placeholder="Enter Subcategory Name" value="{{ old('name') }}" >
				  ...
				  <div class="form-group row mb-lg-4">
				    <label for="category" class="col-lg-3 col-form-label">Category: <sup class="text-danger">*</sup></label>
				    <div class="col-lg-9">
